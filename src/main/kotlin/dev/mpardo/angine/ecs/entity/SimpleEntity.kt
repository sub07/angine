package dev.mpardo.angine.ecs.entity
...
private class SimpleEntity : Entity, KoinComponent {
...
private class SimpleEntityFilter(private val conf: EntityFilter.Conf) : EntityFilter {
...
val simpleEntityModule = module {
    factory<Entity> { SimpleEntity() }
    factory<EntityFilter> { SimpleEntityFilter(it.get()) }
}